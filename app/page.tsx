...
//   const spiceData = [
//     { name: 'Cumin', image: '/cumin.47521f94b40b2a01b035.png' },
//     { name: 'Green Cardamom', image: '/cardamom.92d9c887ceb3152b7308.png' },
//     { name: 'Fennel', image: '/fennel.b40e068c41645f88c56a.png' },
//     { name: 'Sesame', image: '/sesame.a3d3b492bb724e3b5c64.png' },
//     { name: 'Ajwain', image: '/ajwain.2fa5a82d5b6f2b69bfaa.png' },
//     { name: 'Fenugreek', image: '/fenugreek.7c1dd01f610d47fbb118.png' },
//     { name: 'Coriander', image: '/coriander.0e028835a6288ddbd12c.png' },
//     { name: 'Chilli', image: '/chilli.4cb97887f4a5e68d5306.png' },
//     { name: 'Turmeric', image: '/turmeric.1ba634171390982c0658.png' },
//     { name: 'Black Pepper', image: '/blackpepper.b37f17754c33f58a7f2f.png' },
//     { name: 'Cloves', image: '/cloves.4e3655e8037736de28db.png' },
...
//       {showQuoteModal && (
//         <QuoteRequestPage onClose={() => setShowQuoteModal(false)} />
//       )}
...
//             <a href="#home" className="px-4 py-2 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-all duration-200 font-medium">Home</a>
...
//             {showHRLink && (
//               <Link href="/internal/hr-system" className="px-4 py-2 text-green-600 hover:text-green-700 hover:bg-green-50 rounded-xl transition-all duration-200 font-medium border border-green-200 animate-pulse">
...
//               <span className="text-sm font-semibold text-slate-700">Built on Trust. Backed by Experience.</span>
//             </div>
...
//               Leading importer of premium-quality spices, delivering authentic flavors
//               sourced from the finest growers worldwide. Specialized in wholesale and bulk
//               spice imports for businesses globally.
//             </p>

//             <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
//               <button 
//                 onClick={() => document.getElementById('products')?.scrollIntoView({ behavior: 'smooth' })}
//                 className="group bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-2xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-300 text-lg shadow-xl hover:shadow-2xl hover:scale-105 flex items-center space-x-2"
//               >
...
//                 className="group border-2 border-slate-300 text-slate-700 px-8 py-4 rounded-2xl font-semibold hover:border-slate-400 hover:bg-slate-50 transition-all duration-300 text-lg backdrop-blur-sm bg-white/60"
//               >
//                 Request Quote
//               </button>
//             </div>
...
//               <SpiceCard key={index} name={spice.name} image={spice.image} />
//             ))}
//           </div>

//           <div className="bg-gradient-to-br from-white via-white to-green-50/30 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-slate-200/50">
//             <h4 className="text-4xl font-bold text-center bg-gradient-to-r from-green-700 to-emerald-600 bg-clip-text text-transparent mb-12">Wholesale & Bulk Distribution</h4>
...
//                 </div>
//                 <h5 className="font-bold mb-4 text-xl text-slate-800 group-hover:text-green-700 transition-colors">Global Sourcing</h5>
//                 <p className="text-slate-600 leading-relaxed">Direct partnerships with authentic spice origins worldwide</p>
//               </div>
//               <div className="group text-center hover:scale-105 transition-transform duration-300">
//                 <div className="w-24 h-24 bg-gradient-to-br from-green-600 to-emerald-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl group-hover:shadow-2xl transition-shadow duration-300">
//                   <ScaleIcon className="w-10 h-10 text-white" />
//                 </div>
//                 <h5 className="font-bold mb-4 text-xl text-slate-800 group-hover:text-green-700 transition-colors">Multiple Grades</h5>
//                 <p className="text-slate-600 leading-relaxed">Various quality grades to meet specific business requirements</p>
//               </div>
//               <div className="group text-center hover:scale-105 transition-transform duration-300">
//                 <div className="w-24 h-24 bg-gradient-to-br from-green-600 to-emerald-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl group-hover:shadow-2xl transition-shadow duration-300">
//                   <CubeIcon className="w-10 h-10 text-white" />
//                 </div>
//                 <h5 className="font-bold mb-4 text-xl text-slate-800 group-hover:text-green-700 transition-colors">Bulk Quantities</h5>
//                 <p className="text-slate-600 leading-relaxed">Competitive pricing for large volume commercial orders</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//       {/* Contact Section */}
//       <section id="contact" className="py-24 bg-gradient-to-br from-white via-slate-50/50 to-green-50/30">
//         <div className="container mx-auto px-6">
...
//           <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm border border-slate-200 rounded-3xl p-10 shadow-2xl">
...
//                       <p className="text-slate-600">Unit 1 - 20 Newkirk Court, Brampton, ON, L6R 3R3</p>
//                     </div>
//                   </div>
//                   <div className="flex items-start space-x-4">
...
//                       <p className="text-slate-600">info@aromaticimpex.com</p>
//                     </div>
//                   </div>
//                   <div className="flex items-start space-x-4">
//                     <GlobeAltIcon className="w-6 h-6 text-green-600 mt-1" />
//                     <div>
//                       <p className="font-semibold text-slate-800">Service Area</p>
//                       <p className="text-slate-600">North America</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//               <div>
//                 <h4 className="text-2xl font-bold text-slate-800 mb-6">Get Started</h4>
//                 <div className="space-y-4">
//                   <button 
//                     onClick={() => setShowQuoteModal(true)}
//                     className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 px-6 rounded-2xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all shadow-lg hover:shadow-xl flex items-center justify-center space-x-2"
//                   >
//                     <span>Request Quote</span>
//                     <ArrowRightIcon className="w-5 h-5" />
//                   </button>
//                   <p className="text-center text-slate-600">
//                     Get a detailed quote for your spice requirements
//                   </p>
//                 </div>
//               </div>
//             </div>
...
import SpiceCard from "@/components/SpiceCard";
import QuoteRequest from '@/app/QuoteRequest/page';
...
export default function Home() {
  ...
  const spiceData = [
    ...
    { name: 'Cloves', image: '/cloves.4e3655e8037736de28db.png' },
    { name: 'Phool Makhana', image: '/phoolmakhana.8f92da39726acfc72517.png' },
    { name: 'Cinnamon', image: '/cinnamon.1e44a32e3ff238534d5c.png' },
    { name: 'Star Anise', image: '/staranise.72a0f1df0fc0c8e1d240.png' },
    { name: 'Bay Leaf', image: '/bayleaf_1.eea0d2d95404eba0b008.png' },
    { name: 'Kalonji', image: '/kalonji.85ac71d33e4d1ef52a6e.png' },
  ];
       ...
       <header className="backdrop-blur-md bg-white/80 border-b border-slate-200/60 sticky top-0 z-50">
         <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <a href="#about" className="px-4 py-2 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-all duration-200 font-medium">About</a>
            <a href="#products" className="px-4 py-2 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-all duration-200 font-medium">Products</a>
            <a href="#contact" className="px-4 py-2 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-all duration-200 font-medium">Contact Us</a>
            {showHRLink && (
              <Link href="/internal/hr-system" className="px-4 py-2 text-green-600 hover:text-green-700 hover:bg-green-50 rounded-xl transition-all duration-200 font-medium border border-green-200 animate-pulse">
                <ClockIcon className="w-4 h-4 inline mr-2" />
                Staff Portal
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="#products"><span>View Product Catalog</span></a>
                <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <Link href="/QuoteRequest"><button className="group border-2 border-slate-300 text-slate-700 px-8 py-4 rounded-2xl font-semibold hover:border-slate-400 hover:bg-slate-50 transition-all duration-300 text-lg backdrop-blur-sm bg-white/60">
                Request Quote
              </button></Link>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <h3 className="text-6xl lg:text-7xl font-bold bg-gradient-to-r from-green-700 via-emerald-600 to-green-800 bg-clip-text text-transparent mb-6 tracking-tight">ABOUT US</h3>
            </div>

            <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
              <div className="space-y-8">
                <div className="relative">
                  <h4 className="text-3xl font-bold text-slate-800 mb-6">Welcome to the Future of Spice Distribution</h4>
                  <div className="w-20 h-1 bg-gradient-to-r from-green-600 to-amber-400 rounded-full mb-8"></div>
                </div>

                <div className="space-y-6">
                  <p className="text-xl text-slate-600 leading-relaxed font-medium">
                    Welcome to <span className="font-bold text-green-700">Aromatic Impex Inc.</span>, your trusted partner for importing
                    the finest quality spices from around the world.
                  </p>
                  <p className="text-lg text-slate-600 leading-relaxed">
                    At Aromatic Impex Inc., our mission is to bring the world's
                    most vibrant and authentic flavors to kitchens across the globe.
                    From the fiery kick of chili to the earthy warmth of turmeric and
                    the aromatic sweetness of cardamom, we ensure that every spice we
                    deliver reflects its true essence and origin.
                  </p>
                  <p className="text-lg text-slate-600 leading-relaxed">
                    Our commitment to quality begins with selecting premium growers and
                    suppliers who share our passion for excellence. With stringent
                    quality checks, eco-friendly practices and a focus on freshness. We
                    ensure that every product meets the highest standards.
                    Whether you're looking for essential spices or specialty
                    blends, we have something to suit every need.
                  </p>
                  <p className="text-lg text-slate-600 leading-relaxed">
                    Whether you're a wholesaler or a business seeking reliable bulk
                    spice imports, Aromatic Impex Inc. is your trusted partner for
                    delivering authentic and premium-quality flavors.
                  </p>
                  <p className="text-lg text-slate-600 leading-relaxed">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-amber-50 border border-green-200/50 rounded-2xl p-6">
                    <p className="text-lg text-slate-700 font-semibold leading-relaxed">
                      Discover the difference with Aromatic Impex Inc. – Where flavor
                      meets authenticity.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-white via-white to-green-50/30 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-slate-200/50 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6">
                    <div className="group flex items-start space-x-4 hover:bg-green-50/50 p-3 rounded-2xl transition-all duration-300">
                      ...
                      <p className="text-slate-600 leading-relaxed">Premium growers and suppliers who share our passion for excellence</p>
                    </div>
                    <div className="group flex items-start space-x-4 hover:bg-green-50/50 p-3 rounded-2xl transition-all duration-300">
                      <div className="w-8 h-8 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full flex-shrink-0 mt-1 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
                        <CheckIcon className="w-4 h-4 text-white" />
                      </div>
                      <p className="text-slate-600 leading-relaxed">Stringent quality checks and eco-friendly practices</p>
                    </div>
                    <div className="group flex items-start space-x-4 hover:bg-green-50/50 p-3 rounded-2xl transition-all duration-300">
                      <div className="w-8 h-8 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full flex-shrink-0 mt-1 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
                        <CheckIcon className="w-4 h-4 text-white" />
                      </div>
                      <p className="text-slate-600 leading-relaxed">Focus on freshness and highest standards</p>
                    </div>
                    <div className="group flex items-start space-x-4 hover:bg-green-50/50 p-3 rounded-2xl transition-all duration-300">
                      <div className="w-8 h-8 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full flex-shrink-0 mt-1 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
                        <CheckIcon className="w-4 h-4 text-white" />
                      </div>
                      <p className="text-slate-600 leading-relaxed">Essential spices and specialty blends for every need</p>
                    </div>
                    <div className="group flex items-start space-x-4 hover:bg-green-50/50 p-3 rounded-2xl transition-all duration-300">
                      <div className="w-8 h-8 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full flex-shrink-0 mt-1 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
                        <CheckIcon className="w-4 h-4 text-white" />
                      </div>
                      <p className="text-slate-600 leading-relaxed">Reliable bulk spice imports for businesses</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-600 via-green-700 to-emerald-700 text-white rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <a href="#contact"><span>Contact Us Today</span></a>
                  <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </button>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="relative">
                ...
                <div className="relative text-white rounded-3xl p-10">
                  ...
                  <div className="space-y-8">
                    <div className="group flex items-start space-x-4 hover:scale-105 transition-transform duration-200">
                      ...
                      <div>
                        ...
                        <p className="text-green-100 text-lg">Unit 1 - 20 Newkirk Court, Brampton, ON, L6R 3R3</p>
                      </div>
                    </div>
                    ...
                    <div className="group flex items-start space-x-4 hover:scale-105 transition-transform duration-200">
                      ...
                      <div>
                        ...
                        <p className="text-green-100 text-lg">info@aromaticimpex.com</p>
                      </div>
                    </div>
                    ...
                    <div className="group flex items-start space-x-4 hover:scale-105 transition-transform duration-200">
                      ...
                      <div>
                        ...
                        <p className="text-green-100 text-lg">North America</p>
                      </div>
                    </div>
                    ...
                    {/* <div className="group flex items-start space-x-4 hover:scale-105 transition-transform duration-200">
                      ...
                      <div>
                        <p className="font-semibold text-lg mb-1">Language</p>
                        <p className="text-green-100 text-lg">English</p>
                      </div>
                    </div> */}
                  </div>
                </div>
